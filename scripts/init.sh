...
# Short-Description: Starts the Spankins service
...
NAME="spankins"
DESC="Spankins service"

# The path to Jsvc
EXEC="/usr/bin/jsvc"

# The path to the folder containing spankins.jar
...
CLASS_PATH="$FILE_PATH/spankins.jar:$FILE_PATH/lib/commons-daemon-1.0.15.jar"

# The fully qualified name of the class to execute
CLASS="za.co.neilson.Spankins"
